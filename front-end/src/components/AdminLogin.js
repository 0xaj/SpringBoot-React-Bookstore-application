...
class AdminLogin extends Component{
    ...
    login = (e) => {
        ...
        axios.get("http://localhost:8080/admin/"+this.state.username+"/"+this.state.password)
        .then((response) => {
    ...
    <div class="container mx-auto card-width">
        <div class="max-w-md mx-auto my-10">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Admin Sign in</h1>
                {/* <p class="text-gray-500 dark:text-gray-400">Customer Sign in</p> */}
            </div>
            <div class="m-7">
                <form action="">
                    <div class="mb-6">
                        <label for="username" class="block mb-2 text-sm text-gray-600 dark:text-gray-400" style ={styleObj}>User Name</label>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between mb-2">
                            <label for="password" class="text-sm text-gray-600 dark:text-gray-400" style ={styleObj} >Password</label>
                    ...
                    <input class="w-full px-3 py-4 text-white bg-indigo-500 rounded-md focus:bg-maroon-600 focus:outline-none"  type="submit" value="Login" />
                   </form>
